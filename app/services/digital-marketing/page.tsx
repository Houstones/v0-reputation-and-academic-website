...
export default function DigitalMarketingPage() {
  ...
  const services = ['SEO Strategy', 'Social Media', 'Email Marketing', 'Content Creation', 'Analytics', 'Ad Management']

  return (
    <div className="w-full">
      <section className="bg-gradient-to-br from-primary via-blue-600 to-primary/90 text-primary-foreground py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-5xl md:text-6xl font-bold mb-6">Digital Marketing</h1>
          <p className="text-xl mb-8 max-w-2xl">Strategic digital marketing solutions to grow your online presence and drive results</p>
      ...
      <section className="bg-primary/5 py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl font-bold mb-12">Marketing Solutions</h2>
