...
export default function BrandingPage() {
  ...
  const services = ['Logo Design', 'Brand Guidelines', 'Business Cards', 'Packaging Design', 'Advertising Materials', 'Social Media Templates']

  return (
    <div className="w-full">
      <section className="bg-gradient-to-br from-primary via-blue-600 to-primary/90 text-primary-foreground py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-5xl md:text-6xl font-bold mb-6">Branding & Creative</h1>
          <p className="text-xl mb-8 max-w-2xl">Create a powerful and memorable brand identity that resonates with your audience</p>
