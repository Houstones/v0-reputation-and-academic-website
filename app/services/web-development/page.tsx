...
export default function WebDevelopmentPage() {
  ...
  const technologies = ['React', 'Next.js', 'Tailwind CSS', 'Database Design', 'API Development', 'Cloud Hosting']

  return (
    <div className="w-full">
      <section className="bg-gradient-to-br from-primary via-blue-600 to-primary/90 text-primary-foreground py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-5xl md:text-6xl font-bold mb-6">Web Design & Development</h1>
          <p className="text-xl mb-8 max-w-2xl">Professional websites and web applications built for performance and conversion</p>
      ...
      <section className="py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl font-bold mb-12">What We Build</h2>
