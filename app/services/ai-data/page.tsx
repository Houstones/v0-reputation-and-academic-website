...
export default function AIDataPage() {
  ...
  const services = ['Model Training', 'Data Pipeline Setup', 'NLP Solutions', 'Computer Vision', 'Time Series Analysis', 'Recommendation Systems']

  return (
    <div className="w-full">
      <section className="bg-gradient-to-br from-primary via-blue-600 to-primary/90 text-primary-foreground py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-5xl md:text-6xl font-bold mb-6">AI Data & Model Support</h1>
          <p className="text-xl mb-8 max-w-2xl">Cutting-edge artificial intelligence and machine learning solutions for your business</p>
      ...
      <section className="bg-primary/5 py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl font-bold mb-12">Services Include</h2>
