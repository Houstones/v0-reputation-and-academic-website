...
export default function BPOPage() {
  ...
  const services = ['Customer Support', 'Data Entry', 'Email Management', 'Scheduling', 'Bookkeeping', 'General Administration']
    ...
    <div className="w-full">
      <section className="bg-gradient-to-br from-primary via-blue-600 to-primary/90 text-primary-foreground py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl mb-8 max-w-2xl">Streamline your business operations with professional outsourcing solutions</p>
      ...
      <section className="bg-primary/5 py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl font-bold mb-12">Operations Support</h2>
