...
const services = [
  ...
  { title: 'AI Agents & Automation', description: 'Hire AI agents that answer calls, manage reviews, and run your back-office — no code required.', href: '/services/ai-agents', icon: Zap, image: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-zF3sXAPZhq2o46Q5MA0tvfNQpKsV3W.png' },
